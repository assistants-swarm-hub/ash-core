...
import { applyMigrations, startTestPostgres, type TestPostgres } from "@assistants-swarm-hub/db/testing";
...
/**
 * Seed a minimal `source_messages` mirror row (`source = 'acme'`). Media rows
...
export async function seedSourceMessage(
  ...
  await ctx.pool.query(
    `INSERT INTO source_messages
     ...
     VALUES ('acme', $1, $2, $3, 'user', $4, now(), $5)
