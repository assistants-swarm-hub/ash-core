 ...
 * `start_agent` tool without needing a chat.
 *
    ...
    <>
      ...
      >
        <Textarea
          ...
          placeholder="Describe the goal — include any links. A dashboard run has no chat or assistant, so it holds the browser tools only. e.g. “Open example.com, find the pricing page, and tell me the cheapest plan.”"
          rows={5}
          disabled={busy}
          autoFocus
        />
